...
describe('Documentation', () => {
  ...
  it('GOOGLE_SERVICES.md',  () => expect(exists('GOOGLE_SERVICES.md')).toBe(true));
  it('docs/ARCHITECTURE.md',() => expect(exists('docs/ARCHITECTURE.md')).toBe(true));
});

describe('GitHub infrastructure', () => {
  it('.github/workflows/ci.yml',                         () => expect(exists('.github/workflows/ci.yml')).toBe(true));
  it('.github/pull_request_template.md',                 () => expect(exists('.github/pull_request_template.md')).toBe(true));
  it('.github/ISSUE_TEMPLATE/bug_report.md',             () => expect(exists('.github/ISSUE_TEMPLATE/bug_report.md')).toBe(true));
  it('.github/ISSUE_TEMPLATE/feature_request.md',        () => expect(exists('.github/ISSUE_TEMPLATE/feature_request.md')).toBe(true));
});

describe('Source structure', () => {
  it('src/components/ui',   () => expect(exists('src/components/ui')).toBe(true));
  it('src/components/features', () => expect(exists('src/components/features')).toBe(true));
...
describe('Key source files', () => {
  it('src/config/firebase.ts',               () => expect(exists('src/config/firebase.ts')).toBe(true));
  it('src/config/env.ts',                    () => expect(exists('src/config/env.ts')).toBe(true));
  it('src/constants/index.ts',               () => expect(exists('src/constants/index.ts')).toBe(true));
  it('src/types/index.ts',                   () => expect(exists('src/types/index.ts')).toBe(true));
  it('src/services/analyticsService.ts',     () => expect(exists('src/services/analyticsService.ts')).toBe(true));
  it('src/components/ui/ErrorBoundary.tsx',  () => expect(exists('src/components/ui/ErrorBoundary.tsx')).toBe(true));
